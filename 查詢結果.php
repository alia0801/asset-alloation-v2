...
// unset($out);
// exec("C:/Python38-32/python.exe 再平衡_risk_月.py 2>error7.txt {$sqlyourname1} {$sqlpassword1}",$out,$ret);
...
unset($out);
exec("C:/Python38-32/python.exe functions/再平衡_risk_日.py 2>error8.txt {$sqlyourname1} {$sqlpassword1}",$out,$ret);
$date_arr = implode(",",explode(" ",$out[0]));
...
unset($out);
exec("C:/Python38-32/python.exe functions/db_get.py 2>error10.txt {$sqlyourname1} {$sqlpassword1}",$out,$ret);
$flame_1 = $out[0];
$flame_2 = $out[1];
$flame_4 = $risk_d[0];
$flame_3 = $risk_d[count($risk_d)-1];
...
?>
  ...
  <header class="masthead text-white text-center" style = "background: #FFBF00;">
    <div class="container d-flex align-items-center flex-column">
      ...
      <img class="masthead-avatar mb-5" src="img/bee_6.png" alt="">

      <!-- Masthead Heading -->
      <h2 class="masthead-heading text-uppercase mb-0">投組更新再平衡</h2><br>
      <h2 class="masthead-heading text-uppercase mb-0">降低你的投資風險</h2>
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">依據數據分析重新平衡你的投資配置</p>
    ...
    <div class="container">
      ...
      <div class="row">
                            ...
                            <div class="col-lg-10">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">過去金流呈現<?php //print_r($risk_y); ?></h4>
                                        ...
                                        <p><div class="chartjs-wrapper"><canvas id="chartjs-0" class="chartjs" width="undefined" height="undefined"></canvas>
                                            ...
                                            "datasets":[{"label":"價值再平衡","data": <?php echo "[ $total_money_d ]"; ?>,"fill":false,"borderColor":"rgb(255, 0, 0)","lineTension":0.1}]},
                                                        "options":{}});
                                            </script>
                                        </div></p>
                                    </div>
