...
<head>
  ...
  <link href="css/freelancer.min.css" rel="stylesheet">
        ...
        //   var expectAge = parseFloat(document.getElementById('expectAge').value);
        //   var expenses = parseFloat(document.getElementById('expenses').value);
          var in_per_year = parseFloat(document.getElementById('in_per_year2').value);
          var risk = parseFloat(document.getElementById('risk2').value);
        //   var year = retireAge - age;
        //   var goal_money = expenses*(expectAge-retireAge)*12*10000*(1.0172**year);
          in_per_year =  in_per_year*10000;
          var first_input = risk*10000;
          ...
          console.log("投資成本=" + C0 + "\tNPV=" + NPV + "\tIRR: " + IRR*100 + "%");
          document.getElementById('result2').value = (IRR*12*100+ "%") ;
        }
    </script>
...
<nav class="navbar navbar-expand-lg text-uppercase fixed-top" id="mainNav" style = "background: 	#2E8B57;">
  ...
  <header class="masthead text-white text-center" style = "background: #FFBF00;">
    <div class="container d-flex align-items-center flex-column">
      ...
      <img class="masthead-avatar mb-5" src="img/bee.png" alt="">
      <!-- Masthead Heading -->
      <h2 class="masthead-heading text-uppercase mb-0">你想要哪一種投資？</h2><br>
      <h2 class="masthead-heading text-uppercase mb-0">DA DA 智能理財通通幫你實現！</h2>
      <!-- Icon Divider -->
      ...
      <br>
            <!-- About Section Content -->
      <div class="row">
      <div class="col-lg-1 mr-auto"></div>
        <div class="col-lg-4 mr-auto" style = "background: #FF8033; padding:30px;">
        <h1><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" style="color:white;" href="#portfolio">樂活退休</a></h1>
        <br>
        <h2>打造第二黃金人生</h2>
        <br>
        <h4>卸下壓力，自在享受生活！</h3>
        <p class="lead">每月 $15,000 ，預期投資報酬率 5% ， 65 歲退休時就擁有 $10,000,000！</p>
        </div>
        <div class="col-lg-2 mr-auto"></div>
        <div class="col-lg-4 mr-auto" style = "background: #FF4D00; padding:30px;">
        <h1><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" style="color:white;" href="#about">圓夢計畫</a></h1>
        <br>
        <h2>無痛理財大法</h2>
        <br>
        <h4>定期投資，實現夢想起飛！</h3>
        <p class="lead">每月 $7,000 ，預期投資報酬率 5% ， 10 年就擁有第一桶金 $1,000,000！</p>
        </div>
        <div class="col-lg-1 mr-auto"></div>
      </div>
  ...
  <!-- Portfolio Section -->
  <section class="page-section portfolio" id="portfolio" style = "background: #8CE600;">
    <div class="container">
      ...
      <form id = "info" action="樂活退休規劃結果.php" method="post" name="info" class="fullwidth">
...
<div class="card text-center" style = "background: #007bff; padding:3px">
    ...
    <button type="button" class="btn btn-primary btn-xl" style = "background: #2E8B57" onclick="add()" >開始試算</button>
    <output class="btn btn-primary btn-xl" style = "background: #2E8B57" id="result">報酬率試算結果</output>
    </div>

    <div class="text-center mt-4">
    <button type="submit" class="btn btn-primary btn-xl" style = "background: #2E8B57" id="sendMessageButton">開始進行資產配置</button>
    </div>
    </form>
  </section>
      ...
      <div class="row">
       ...
       <!-- <div class="row"> -->
        <!-- <div class="col-lg-8 mx-auto"> -->
          ...
          <form id = "info" action="圓夢計畫規劃結果.php" method="post" name="info" class="fullwidth" >
          <div class="row">
...
<div class="card text-center" style = "background: #FFA500; padding:5px">
                            <div class="stat-widget-two">
                                <div class="stat-content">
                                    <!-- <div class="card bg-retired"  style = "background: #dae8e8"> -->
                                    <div class="card bg-retired" style = "background: #FFE4C4">
                                            ...
                                            <div class="col-xs-9" >
                                              <!-- <div class="input-group mb-3"> -->
                                                <div class="input-group" >
                                                    <input type="hidden" name="yourname" value="<?php print_r($yourname);?>"/>
                                                    <input type="hidden" name="password" value="<?php print_r($password);?>"/>
                                                    <input boundaryMsg="建議投資期間為1至20年" placeholder="年" class="form-control typeahead tt-input" id="period" max="20" min="1" name="period" type="number" value="" />
                                                        <!-- <span class="unitname">歲</span> -->
                                ...
                                <div class="stat-content">
                                    <div class="card bg-retired" style = "background: #FFE4C4">
                                        ...
                                        <!-- <div class="row p-l-10 p-r-10"> -->
                                            <div class="col-xs-9">
                                                <div class="input-group">
                                                    <input boundaryMsg="建議目標金額為1萬元至500萬元" placeholder="萬元" class="form-control typeahead tt-input" id="totalAmt" max="501" min="1" name="totalAmt" type="number" value="" />
                                                        <!-- <span class="unitname">歲</span> -->
                                                </div>
                                            </div>
                                        <!-- </div> -->
                                ...
                                <div class="stat-content">
                                    <div class="card bg-retired" style = "background: #FFE4C4">
                                        ...
                                        <!-- <div class="row p-l-10 p-r-10"> -->
                                            <div class="col-xs-9">
                                                <div class="input-group">
                                                    <input boundaryMsg="建議每年投入金額為1至100萬" placeholder="萬元" class="form-control typeahead tt-input" id="in_per_year2" max="100" min="1" name="in_per_year2" type="number" value="" />
                                                    <!-- <span class="unitname">萬元</span> -->
                                                </div>
                                            </div>
                                            
                                        <!-- </div> -->
                                        <p class="inputDesc">建議評估您自身負擔能力進行試算。<br> </p>
                                        <div class="notification error closeable" id="expensesMsg" style="display: none">
                                            <p><span>Error!</span></p>
                                            <a class="close"></a>
                                        </div>
...
<div class="card text-center" style = "background: #FFA500; padding:5px">
                            <div class="stat-widget-two">
                                <div class="stat-content">
                                    <div class="card bg-retired" style = "background: #FFE4C4">
                                        <h3 class="card-title">4. 第一次投入金額 </h3><!-- 設定可承受之投資風險 -->
                                        <!-- <div class="row p-l-10 p-r-10"> -->
                                            <div class="col-xs-9">
                                                <div class="input-group">
...
<div class="card text-center" style = "background: #FFA500; padding:5px">
                            <div class="stat-widget-two">
                                <div class="stat-content">
                                    <div class="card bg-retired" style = "background: #FFE4C4">
                                        <h3 class="card-title">5.資料時間長度 </h3><!-- 設定可承受之投資風險 -->
                                        <!-- <div class="row p-l-10 p-r-10"> -->
                                            <div class="col-xs-9">
                                                <div class="input-group">
                                                    <input boundaryMsg="資料長度為5年內" placeholder="年" class="form-control typeahead tt-input" id="want_calc2" max="5" min="1" name="want_calc2" type="number" value="" />
                                                    <!-- <span class="unitname">級</span> -->
                                                </div>
                                            </div>
...
<div class="text-center mt-4">
    <button type="button"style = "background: #FF4D00; color:white" class="btn btn-xl" onclick="add2()" >開始試算</button>
    <output class="btn btn-xl" style = "background: #FF8033; color:white" id="result2">報酬率試算結果</output>
    </div>

<div class="text-center mt-4">
<button type="submit" class="btn btn-xl" id="sendMessageButton" style = "background: #FF4D00; color:white">開始進行資產配置</button>
</div>
</form>
