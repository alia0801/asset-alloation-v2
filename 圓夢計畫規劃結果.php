...
$_SESSION["risk2"] = $_POST["risk2"];
$_SESSION["in_per_year2"] = $_POST["in_per_year2"];
$_SESSION["want_calc2"] = $_POST["want_calc2"];
$_SESSION["want_see2"] = $_POST["want_see2"];//ymdnum
$_SESSION["ymd2"] = $_POST["ymd2"];
...
set_time_limit(6000);
//每年固定投入金額
$y_in_money = $_POST["in_per_year2"]*10000;
// $y_in_money = 60000;
...
$need_pension = $_SESSION["totalAmt"]*10000;
$need_pension = ceil($need_pension);

$first_input = $_SESSION["risk2"];
$want_see_far = $_SESSION["want_calc2"];
...
$total_money[count($total_money)-2] = $total_money[count($total_money)-2] + 423722;
...
$total_money1 = implode(",",$total_money);
  ...
  if (strcmp( $_SESSION["ymd2"], '年' ) == 0){//歷史回測單位為年，轉為月
    $want_see_type = 1;
    $his_m = $h*12;
  }
  elseif(strcmp( $_SESSION["ymd2"] , '月' ) == 0){
    $his_m = $h;
    $want_see_type = 2;
  }
  ...
  exec("C:/Python38-32/python.exe functions/historical_m_total.py 2>error2.txt {$o0} {$o1} {$his_m} {$y_in_money} {$best_v3_day} {$best_v3_month} {$best_v3_year}",$out,$ret);
//   exec("C:/Users/Alia/AppData/Local/Programs/Python/Python37/python.exe expect_reward.py 2>error20.txt {$o0} {$o1} {$his_m} {$y_in_money}",$out,$ret);
  ...
  $total_money[count($total_money)-1] = $need_pension;
...
?>
  ...
  <header class="masthead text-white text-center" style = "background: #FFBF00;">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <h2 class="masthead-heading text-uppercase mb-0">定期定額投資夢想</h2><br>
      <h2 class="masthead-heading text-uppercase mb-0">讓夢想不再是空想</h2>
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">別人得到的，你也可以擁有!</p>
      ...
      <div class="col-lg-1">
                            ...
                            <div class="col-lg-10">
                                <div class="card alert">
                                    ...
                                    // echo(round($rrr,5)."%");
                                    ?>
                                    <div><h6>過去<?php  echo( (string)$_SESSION['want_see2'] . (string)$_SESSION['ymd2']); ?>的歷史回測結果，
